        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <a 
              ...
              aria-label="Shopee" 
              className="w-8 h-8 flex items-center justify-center bg-black dark:bg-white text-white dark:text-black rounded hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
            >
          ...
          <div className="flex items-center gap-4 text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-400 mt-4">
            <Link to="/privacy" className="hover:text-black dark:hover:text-white transition-colors">Privacy Policy</Link>
            <span className="text-gray-400 dark:text-gray-600">|</span>
            <Link to="/terms" className="hover:text-black dark:hover:text-white transition-colors">Terms and Conditions</Link>
          </div>
        </div>
