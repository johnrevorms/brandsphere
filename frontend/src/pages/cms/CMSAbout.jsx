    ...
    <DashboardLayout role="cms">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Atur judul halaman, kutipan inspiratif, deskripsi profil, dan gambar utama.</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-gray-50 dark:bg-gray-900 border border-black/10 dark:border-white/10 rounded-3xl p-8 flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <label className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Judul Utama Halaman</label>
            <input
              type="text"
              value={aboutTitle}
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Quote / Slogan (Besar)</label>
            <textarea
              rows={3}
              value={aboutQuote}
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Deskripsi Profil Utama</label>
            <textarea
              rows={10}
              value={aboutContent}
        ...
        <div className="bg-gray-50 dark:bg-gray-900 border border-black/10 dark:border-white/10 rounded-3xl p-8 flex flex-col gap-6">
          <h2 className="text-lg font-bold italic border-b border-black/10 dark:border-white/10 pb-4">Media & Visual</h2>
          ...
          <div className="bg-white dark:bg-black/50 border border-white/5 rounded-xl p-4 mt-4">
            <h3 className="text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wider mb-2">Tips Visual</h3>
            <ul className="text-xs text-gray-600 dark:text-gray-500 list-disc list-inside space-y-1">
