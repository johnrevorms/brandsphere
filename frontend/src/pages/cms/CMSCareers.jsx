...
export default function CMSCareers() {
  ...
  const inputCls = "bg-black border border-white/20 rounded-lg p-3 text-white focus:outline-none focus:border-white transition";
    ...
    <DashboardLayout role="cms">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-2">Tambah, edit, dan kelola lowongan pekerjaan.</p>
        </div>
        ...
        <div className="bg-gray-900 border border-white/10 rounded-3xl p-8 mb-8">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-400">Posisi Pekerjaan *</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-400">Kota Lokasi *</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-400">Tipe Waktu</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-400">Tipe Lokasi</label>
            ...
            <div className="md:col-span-2 flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-400">Deskripsi Pekerjaan *</label>
              <textarea 
                required 
                rows={6} 
      ...
      <div className="bg-gray-900 border border-white/10 rounded-3xl overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-black/50 border-b border-white/10">
            <tr>
              <th className="p-4 font-semibold text-gray-400">Posisi</th>
              <th className="p-4 font-semibold text-gray-400">Detail</th>
              <th className="p-4 font-semibold text-gray-400 text-right">Aksi</th>
            </tr>
          </thead>
          <tbody>
            {careers.map((career) => (
              <tr key={career.id} className="border-b border-white/10 hover:bg-white/5 transition">
                ...
                <td className="p-4 text-sm text-gray-300">
                  ...
                  <span className="text-gray-400">{career.city}</span>
                </td>
            ...
            {careers.length === 0 && (
              <tr><td colSpan="3" className="p-8 text-center text-gray-500 italic">Belum ada lowongan.</td></tr>
            )}
          </tbody>
        </table>
      </div>
