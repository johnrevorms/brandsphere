  ...
  return (
    <div className="min-h-screen bg-black text-white pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4">
        <p className="text-xs tracking-[0.4em] uppercase text-gray-500 font-mono mb-4 text-center">— Kebijakan —</p>
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-6 text-gray-300 leading-relaxed">
            <div className="bg-gray-900 border border-white/10 rounded-2xl p-6">
              ...
              <ul className="mt-4 flex flex-col gap-2 list-disc list-inside text-gray-400">
