  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white pt-32 pb-12 px-4 flex flex-col items-center justify-center">
      ...
      <h1 className="text-4xl md:text-5xl font-bold italic tracking-widest uppercase mb-4 text-center">
        Pembayaran <span className="text-gray-600 dark:text-gray-500">Berhasil</span>
      </h1>
      ...
      <div className="flex gap-4">
        ...
        <Link to="/products" className="bg-transparent border border-white text-black dark:text-white px-8 py-3 rounded-full font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-colors">
          Belanja Lagi
        </Link>
      </div>
    </div>
