  ...
  return (
    <div className="min-h-screen bg-black text-white pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-4 md:px-8">
        ...
        <p className="text-gray-400 text-center mb-16 italic text-sm tracking-widest">
        ...
        <form onSubmit={handleSubmit} className="bg-white/[0.02] backdrop-blur-xl border border-white/10 p-8 md:p-12 space-y-8 rounded-3xl">
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <label className="block text-xs font-mono text-white/70 tracking-widest uppercase mb-3">Nama Lengkap</label>
              <input
                type="text"
                required
                value={name}
                onChange={e => setName(e.target.value)}
                className="w-full bg-transparent border-b border-white/30 pb-2 text-sm text-white focus:outline-none focus:border-white transition-colors placeholder-white/40"
                placeholder="Nama Anda"
              />
            </div>
            <div>
              <label className="block text-xs font-mono text-white/70 tracking-widest uppercase mb-3">Nomor Telepon</label>
              <input
                type="text"
                value={phone}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <label className="block text-xs font-mono text-white/70 tracking-widest uppercase mb-3">Email (Tidak bisa diubah)</label>
              <input
                type="email"
                disabled
                value={user.email}
                className="w-full bg-white/5 border-b border-white/10 pb-2 text-sm text-white/50 cursor-not-allowed"
              />
            </div>
          </div>

          <div className="pt-4 border-t border-white/10">
            <h2 className="text-sm font-bold tracking-[0.2em] uppercase text-white/70 mb-6">Info Pengiriman Default</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-transparent border-b border-white/30 pb-2 text-sm text-white focus:outline-none focus:border-white transition-colors resize-none h-20 placeholder-white/40"
