...
function AlertStyleNotification({ message }) {
  ...
  return (
    <div className="fixed inset-x-0 top-3 z-50 flex justify-center px-4 pointer-events-none">
      <div className="w-[520px] max-w-[calc(100vw-32px)] min-h-[150px] bg-[#1f2026] text-white border border-white/15 rounded-2xl shadow-2xl px-7 py-6">
        <p className="text-lg mb-5">localhost:5173 says</p>
