  ...
  return (
    <div className="min-h-screen bg-black text-white pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4">
        <p className="text-xs tracking-[0.4em] uppercase text-gray-500 font-mono mb-4 text-center">— Panduan —</p>
        <h1 className="text-5xl italic font-bold mb-4 uppercase tracking-widest text-center">How to Order</h1>
        <p className="text-gray-400 text-center mb-16">Memesan dari Arcanum semudah ini.</p>
        ...
        {loading ? (
          ...
          <div className="bg-gray-900 border border-white/10 rounded-2xl p-8">
            <div className="text-gray-300 leading-relaxed whitespace-pre-wrap text-sm">{cmsContent}</div>
          </div>
        ) : (
          <div className="flex flex-col gap-4">
            {steps.map(step => (
              <div key={step.num} className="bg-gray-900 border border-white/10 rounded-2xl p-6 flex items-start gap-6">
                <span className="text-4xl font-bold italic text-white/20 min-w-[56px]">{step.num}</span>
                <div>
